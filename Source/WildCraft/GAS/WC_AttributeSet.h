 ...
 */
UCLASS()
class WILDCRAFT_API UWC_AttributeSet : public UAttributeSet
{
	GENERATED_BODY()
public:
	...
	ATTRIBUTE_ACCESSORS(UWC_AttributeSet, AttackPower)
